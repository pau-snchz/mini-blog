<x-layout>
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        <div class="bg-white rounded-lg border-2 border-[#ac764e] shadow-[4px_4px_0px_#ac764e] p-8">
            <h1 class="text-3xl font-bold mb-8 text-center text-[#ac764e]">Create New Blog Post</h1>
            ...
            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data" id="blogForm">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="cafe_name" name="cafe_name" value="{{ old('cafe_name') }}"
                           ...
                           placeholder="Enter cafe name" required>
                    @error('cafe_name')
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="location" name="location" value="{{ old('location') }}"
                           ...
                           placeholder="Enter cafe location" required>
                    @error('location')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="opening_hours" name="opening_hours" value="{{ old('opening_hours') }}"
                           ...
                           placeholder="e.g., Mon-Sun 8:00 AM - 10:00 PM" required>
                    @error('opening_hours')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="6"
                              ...
                              placeholder="Write a detailed description of the cafe..." required>{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" id="blogger_top_drink" name="blogger_top_drink" value="{{ old('blogger_top_drink') }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="blogger_top_food" name="blogger_top_food" value="{{ old('blogger_top_food') }}"
                               ...
                               placeholder="e.g., Blueberry Cheesecake" required>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" id="score_affordability" name="score_affordability"
                                       min="1" max="10" value="{{ old('score_affordability') }}"
                                       ...
                                       placeholder="1-10" required onchange="calculateOverallScore()">
                            ...
                            <div>
                                ...
                                <input type="number" id="score_ambiance" name="score_ambiance"
                                       min="1" max="10" value="{{ old('score_ambiance') }}"
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" id="score_taste" name="score_taste"
                                       min="1" max="10" value="{{ old('score_taste') }}"
                            ...
                            <div>
                                ...
                                <input type="number" id="score_overall" name="score_overall"
                                       min="1" max="10" value="{{ old('score_overall') }}" step="0.1"
                ...
                <div class="mb-8">
                    <label for="pictures" class="block text-sm font-medium text-gray-700 mb-2">
                        Pictures (Optional - Max 5 images)
                    </label>
    ...
    <script>
        ...
        function calculateOverallScore() {
            ...
            // Only calculate if all three scores are provided
            if (affordability > 0 && ambiance > 0 && taste > 0) {
                const average = (affordability + ambiance + taste) / 3;
                // Round to 1 decimal place
                const roundedAverage = Math.round(average * 10) / 10;
                document.getElementById('score_overall').value = roundedAverage;
            } else {
                document.getElementById('score_overall').value = '';
            }
        }

        // Calculate overall score on page load if old values exist
        ...
        function removePreview(element, index) {
            ...
            // You could implement file removal logic here if needed
        }
